...
var (
	...
	number                map[string]int = map[string]int{"一": 1, "二": 2, "三": 3, "四": 4, "五": 5, "六": 6, "七": 7, "八": 8, "九": 9, "十": 10, "十一": 11, "十二": 12}
...
func (l *Lunar)ToLunar(date string) (dataLunar string, m int, d int) {
	...
	dataLunar = cyclical() + animalsYear() + "年" + doubleMonth + chineseNumber[month-1] + "月" + getChinaDayString(day)
	m = number[chineseNumber[month-1]]
	d = day
	return
